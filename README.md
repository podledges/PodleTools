...
- [`tools/clipboard-images/`](tools/clipboard-images/) — NixOS/Pi `paste-capture` wrapper plus the Pi-owned Alt+V screenshot extension (source in-repo; live install is a separate current-user step).
